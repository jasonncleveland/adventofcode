...
internal sealed class Day17 : AbstractDaySolver<IReadOnlyList<string>>
{
    ...
    private static HashSet<(int x, int y, int z, int w)> GetNeighboursRec((int x, int y, int z, int w) cube, (int x, int y, int z, int w) neighbour, int index)
    {
        HashSet<(int x, int y, int z, int w)> neighbours = new();
    ...
    private static int CountActiveNeighboursRec(HashSet<(int x, int y, int z, int w)> activeCubes, (int x, int y, int z, int w) cube, (int x, int y, int z, int w) neighbour, int index)
    {
        if (index == 4)
        {
